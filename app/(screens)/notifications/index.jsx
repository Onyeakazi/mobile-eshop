...
export default function Notifications() {
    return (
        <SafeAreaView style={{flex: 1, paddingHorizontal: 20, backgroundColor: "white"}}>
            ...
            {/* Other pages */}
            <View>
                <View style={{width: "100px", height: 1, backgroundColor: "#E6E6E6", marginBottom: 25}}></View>
                ...
                <View style={{width: "100px", height: 1, backgroundColor: "#e6e6e6"}}></View>
            ...
            <View style={{flexDirection: "colunm", justifyContent: "space-between", marginTop: 20}}>
                    ...
                    <View style={{width: "10px", height: 1, backgroundColor: "#e6e6e6", marginVertical: 20, marginLeft: 46}}></View>
                ...
                <View style={{width: "100px", height: 1, backgroundColor: "#e6e6e6", marginVertical: 20}}></View>
